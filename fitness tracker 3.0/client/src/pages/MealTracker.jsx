      ...
      >
        ...
        {activeTab === 'manual' && (
          <form onSubmit={handleSaveManualMeal} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full py-3 bg-green-700 hover:bg-green-600 text-white font-sora font-semibold rounded-xl text-sm transition-colors shadow-sm flex items-center justify-center space-x-2"
            >
