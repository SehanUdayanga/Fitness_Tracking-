...
const AdminAIMonitoring = () => {
  ...
  return (
    <div className="space-y-8 max-w-5xl">
      {/* Header */}
      <div>
        <h2 className="font-sora font-bold text-xl text-navy-900">AI Monitoring &amp; Configuration</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-line shadow-xs p-6 space-y-5">
            <div className="flex items-center justify-between border-b border-line pb-4">
              <div className="flex items-center space-x-2.5">
                ...
                <div>
                  <h3 className="font-sora font-bold text-base text-navy-900">AI Service Status</h3>
            ...
            >
              ...
              <div className="text-right">
                <span className="text-[10px] font-mono text-slate-500 uppercase block">Provider</span>
            ...
            <div className="space-y-3 text-xs">
              <div className="flex items-center justify-between py-2 border-b border-line">
                ...
                <span className="font-semibold text-navy-900 flex items-center space-x-1.5">
              ...
              <div className="flex items-center justify-between py-2 border-b border-line">
                <span className="text-slate-500 font-medium">Current AI Model</span>
              ...
              <div className="flex items-center justify-between py-2 border-b border-line">
                <span className="text-slate-500 font-medium">Last API Check</span>
            ...
            <div className="pt-2 space-y-2.5">
              ...
              <div className="grid grid-cols-3 gap-2 text-center">
                <div className="p-2.5 rounded-xl bg-slate-50 border border-line">
                  <span className="text-[10px] text-slate-400 font-mono block">Requests</span>
                  <span className="font-sora font-bold text-base text-navy-900 mt-0.5 block">
                    {statusData.requestsToday}
                  </span>
                </div>
                <div className="p-2.5 rounded-xl bg-green-50/50 border border-green-200">
                  <span className="text-[10px] text-green-700 font-mono block">Success</span>
                  <span className="font-sora font-bold text-base text-green-700 mt-0.5 block">
                    {statusData.successfulRequests}
                  </span>
                </div>
                <div className="p-2.5 rounded-xl bg-rose-50/50 border border-rose-200">
                  <span className="text-[10px] text-rose-700 font-mono block">Failed</span>
                  <span className="font-sora font-bold text-base text-rose-700 mt-0.5 block">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-2xl border border-line shadow-xs p-6 space-y-6">
            <div className="flex items-center space-x-2.5 border-b border-line pb-4">
              <div className="w-8 h-8 rounded-lg bg-blue-100 text-blue-700 flex items-center justify-center">
                <Sliders className="w-4 h-4" />
              </div>
              <div>
                <h3 className="font-sora font-bold text-base text-navy-900">AI Configuration</h3>
            ...
            <form onSubmit={handleSaveConfig} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    disabled
                    value="Google Gemini"
                    className="w-full px-3.5 py-2.5 rounded-xl border border-line bg-slate-100 text-slate-700 text-sm font-semibold cursor-not-allowed"
                  />
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <span className="text-[11px] font-mono text-slate-400">
                    Current: <span className="text-slate-700 font-semibold">{config.apiKeyMasked}</span>
                  </span>
                </div>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-line bg-[#FAFAF8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-600 text-sm text-navy-900 font-mono"
                  />
                </div>
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 rounded-xl border border-line bg-[#FAFAF8] focus:bg-white focus:outline-none focus:ring-2 focus:ring-green-600 text-sm text-navy-900 font-medium cursor-pointer"
                >
              ...
              <div className="pt-4 border-t border-line flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3">
                <button
                  ...
                  className="px-4 py-2.5 bg-white border border-line hover:bg-slate-50 text-slate-700 font-semibold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center space-x-2 disabled:opacity-50"
                >
